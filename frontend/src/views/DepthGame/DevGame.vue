...
import Board from '@/components/DepthGame/Board.vue';
import LevelBuilder from '@/components/DepthGame/LevelBuilder.vue';
import LevelSelector from '@/components/DepthGame/LevelSelector.vue';
import { DEPTH_DECKS, getDeckArchetype } from '@/game/DepthGame/constants/deckArchetypes';
import { DEPTH_LEVEL_INPUTS } from '@/game/DepthGame/constants/levelInputs';
import { DEPTH_LEVELS } from '@/game/DepthGame/constants/levels';
import type { LevelInput, RevealRecord } from '@/game/DepthGame/types';
