...
import { trackGameComplete, trackGameStart } from '@/shared/utils/analyticsEvents';

const Story = defineAsyncComponent(() => import('@/shared/components/Story.vue'));
...
const PuzzleCompletionModal = defineAsyncComponent(
  () => import('@/shared/components/PuzzleCompletionModal.vue')
);
