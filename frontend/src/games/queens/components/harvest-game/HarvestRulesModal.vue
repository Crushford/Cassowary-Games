<template>
  <RulesModalBase
    :is-visible="props.store.showGameRules"
    :analytics-params="{ game_name: 'harvest', game_mode: 'campaign' }"
    close-button-class="bg-semantic-warning-500 hover:bg-semantic-warning-400 text-semantic-neutral-900"
    @close="props.store.closeRulesModal()"
  >
    <div
    ...
    >
      ...
      <div class="bg-semantic-info-800 p-4 rounded-lg space-y-1">
        ...
        <ul class="list-disc list-inside space-y-1">
          <li>Use <strong>flags</strong> (🚧) to mark squares where you know there is no honey</li>
