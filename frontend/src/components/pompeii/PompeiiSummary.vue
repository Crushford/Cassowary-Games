<template>
  <div class="w-full bg-gray-800 rounded-lg p-4 mb-6">
    <h2 class="text-xl font-bold text-white mb-4">City Status</h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <!-- Wall Upgrades Section -->
      <div class="bg-gray-700 rounded p-4">
        <h3 class="text-sm font-semibold text-gray-300 mb-2">Wall Upgrades</h3>
      ...
      <div class="bg-gray-700 rounded p-4">
        <h3 class="text-sm font-semibold text-gray-300 mb-2">City Production Centers</h3>
      ...
      <div class="bg-gray-700 rounded p-4">
        <h3 class="text-sm font-semibold text-gray-300 mb-2">City Revenue Upgrades</h3>
        <div class="text-2xl font-bold text-white mb-1">
    ...
    <div class="mt-4 pt-4 border-t border-gray-600">
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <span class="text-sm font-semibold text-gray-300">City income</span>
          <span class="text-lg font-bold text-green-400"> {{ cityIncome }} gold / year </span>
        </div>
        <div v-if="countrysideIncome > 0" class="flex items-center justify-between">
          <span class="text-sm font-semibold text-gray-300">Countryside income</span>
          <span class="text-lg font-bold text-green-400">
            {{ countrysideIncome }} gold / year
          </span>
        </div>
        <div class="flex items-center justify-between pt-2 border-t border-gray-600">
          <span class="text-lg font-semibold text-gray-300">Total income</span>
