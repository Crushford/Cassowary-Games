<template>
  <Transition name="cookie-banner">
    <div
      ...
      class="fixed bottom-0 left-0 right-0 z-50 bg-semantic-neutral-800 border-t-2 border-semantic-warning-600 shadow-lg"
    >
      <div class="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div class="flex gap-3 flex-shrink-0">
            <button
              class="px-4 py-2 text-sm font-medium text-semantic-neutral-300 hover:text-white transition-colors"
              @click="decline"
            >
              Decline
            </button>
            <button
              class="px-6 py-2 text-sm font-semibold bg-semantic-warning-600 hover:bg-semantic-warning-500 text-white rounded-lg transition-colors"
              @click="accept"
            >
              Accept
            </button>
