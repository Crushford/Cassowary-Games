    ...
    viteFinal: function (config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                config.resolve.alias = __assign(__assign({}, (((_a = config.resolve) === null || _a === void 0 ? void 0 : _a.alias) || {})), { '@': path.resolve(__dirname, '../src') });
                // Carry over any define values used in app build that stories may import
                config.define = __assign(__assign({}, (config.define || {})), { 'import.meta.env.VITE_PAGES_URL': JSON.stringify(process.env.CI_PAGES_URL || '') });
                // Loosen fs boundary just in case stories import from root-level paths
                config.server = __assign(__assign({}, (config.server || {})), { fs: __assign(__assign({}, (((_b = config.server) === null || _b === void 0 ? void 0 : _b.fs) || {})), { strict: false }) });
