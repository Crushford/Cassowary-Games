...
const FEATURE_DEFINITIONS: DiversityFeatureDefinition[] = [
  ...
  },
  {
    ...
    meaning:
      'How uneven region sizes are (higher means larger size differences between regions).',
    weight: 1.2
  },
  {
  ...
  },
  {
    ...
    meaning:
      'Average elongation of regions (higher means more stretched, corridor-like shapes).',
    weight: 1.15
  },
  {
    ...
    meaning:
      'How densely regions touch each other (higher means more interlocked region borders).',
    weight: 0.9
  },
  {
    ...
    meaning:
      'Fraction of cells on the board edge (higher means shapes lean more toward borders).',
    weight: 0.6
  }
]
...
export function extractPuzzleDiversityFeatures(
  ...
  const regionElongationNorm =
    ...
    Math.max(1, elongationValues.length)
