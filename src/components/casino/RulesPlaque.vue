<template>
  <div
    ...
    class="max-w-[560px] mx-auto bg-[#0f3b2e] border-[1.5px] border-[#d4af37] rounded-xl shadow-[0_8px_24px_rgba(0,0,0,0.35)] p-4 sm:p-4 p-3 transition-all duration-120 ease-out transform scale-100 hover:scale-[1.02] motion-reduce:transition-none motion-reduce:hover:scale-100"
  >
    <!-- Title row -->
